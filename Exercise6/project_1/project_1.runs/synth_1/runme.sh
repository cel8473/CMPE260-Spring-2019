...
HD_PWD='F:/DSD-II/Exercise6/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WriteBack_stagetb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WriteBack_stagetb.tcl
