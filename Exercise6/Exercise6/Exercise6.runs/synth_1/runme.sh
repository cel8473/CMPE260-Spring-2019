...
HD_PWD='F:/DSD-II/Exercise6/Exercise6/Exercise6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WriteBack_Stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WriteBack_Stage.tcl
