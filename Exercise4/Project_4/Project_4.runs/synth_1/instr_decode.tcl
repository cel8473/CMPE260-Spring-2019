...
read_vhdl -library xil_defaultlib D:/DSD-II/Exercise4/Project_4/Project_4.srcs/sources_1/new/instr_decode.vhd
...
synth_design -top instr_decode -part xc7vx485tffg1157-1


write_checkpoint -force -noxdef instr_decode.dcp

catch { report_utilization -file instr_decode_utilization_synth.rpt -pb instr_decode_utilization_synth.pb }
