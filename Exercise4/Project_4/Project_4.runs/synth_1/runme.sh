...
HD_PWD='D:/DSD-II/Exercise4/Project_4/Project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instr_decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instr_decode.tcl
