...
HD_PWD='D:/DSD-II/Exercise4/Project_4/Project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instr_decode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instr_decode.tcl -notrace
