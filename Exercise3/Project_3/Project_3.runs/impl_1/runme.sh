...
HD_PWD='D:/DSD-II/Exercise3/Project_3/Project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction_fetch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instruction_fetch.tcl -notrace
